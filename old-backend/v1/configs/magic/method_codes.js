const methodCodes = {
	direction_estimation: {
		codes: [
			{
				urls: [
					'https://earthref.org/MagIC/books/Tauxe/Essentials/#x1-1130009.7',
				],
				code: 'DE-BFL',
			...
			},
			{
				...
				code: 'DE-MAD-P',
				definition:
					'Maximum angle of deviation: Estimated about best-fit plane',
			},
			{
				code: 'DE-NRM',
			...
			},
			{
				code: 'DE-TROUT',
				definition:
					'Thermal Resolution of Unblocking Temperatures (TROUT) method',
				description:
					'Direction estimation and automatic component picking using the TROUT method. With this method, the meas_step_min and meas_step_max columns represent the range of temperatures where 95% of the unblocking magnetization is in the considered component',
			},
			{
				code: 'DE-V',
				definition:
	...
	sample_orientation: {
		codes: [
			...
			{
				urls: [
					'https://earthref.org/MagIC/books/Tauxe/Essentials/#x1-1060009.1.2',
				],
				code: 'SO-POM',
	...
	lab_protocol: {
		codes: [
			...
			},
			{
				...
				description:
					'Measure of anisotropy of anhysteretic susceptibility (AAS) via ARM acquisition (AARM). A fully demagnetized specimen is subject to ARM in three to fifteen (tensor) directions while being demagnetized after each of the ARM steps in the direction of the next ARM.',
			},
			{
				code: 'LP-AN-DC',
				definition: 'Anisotropy measurement: ARM acquisition with a DC field',
				description:
					'anisotropy of anhysteretic remanence where the DC bias field was applied from a maximum alternating field to 0 mT.',
			},
			{
				code: 'LP-AN-DCP',
				definition:
					'Anisotropy measurement: ARM acquisition with a DC field for part of the acquisition',
				description:
					'Anisotropy measurement: Anisotropy of anhysteretic remanence where the DC bias field was applied from a maximum alternating field to a minimum alternating field, where the minimum AF is > 0 mT.',
			},
			{
				code: 'LP-AN-IRM',
			...
			{
				description:
					'Susceptibility measured in multiple positions to determine susceptibility tensor.',
				code: 'LP-AN-MS',
			...
			{
				description:
					'Application of progressively larger DC fields to an sIRM to determine the field required to reduce it to zero.',
				code: 'LP-BCR-BF',
				definition: 'Coercivity of remanence: Back field method',
			},
			{
				description:
					'Field at which ascending loop (after subtraction of Mr) crosses the descending loop.',
				code: 'LP-BCR-CAD',
				definition:
					'Coercivity of remanence: Crossing of ascending / descending loops',
			},
			{
				description:
					'Field at which difference between ascending and descending hysteresis loops is half the magnitude of the zero field crossings.',
				code: 'LP-BCR-HDM',
			...
			{
				description:
					'Variable temperature measurement sequence (e.g. in QD-MPMS) with magnetization measurements while cooling and rewarming.',
				code: 'LP-CW-NRM',
			...
			},
			{
				...
				code: 'LP-CW-SIRM',
				definition:
					'Cycling between cooling and warming: Room temperature SIRM',
			},
			{
				IAGA: 'DC0',
				...
				code: 'LP-DC0',
				definition:
					'No demagnetization carried out but only NRM values reported',
			},
			{
				IAGA: 'DC1',
				urls: ['https://earthref.org/MagIC/books/Tauxe/Essentials/#x1-1970341'],
				code: 'LP-DC1',
				definition:
					'Pilot demagnetizations on some samples suggest stability but only NRM values reported',
			},
			{
				IAGA: 'DC2',
				urls: ['https://earthref.org/MagIC/books/Tauxe/Essentials/#x1-1970341'],
				code: 'LP-DC2',
				definition:
					'Bulk demagnetization carried out on all samples but no vector diagrams shown',
			},
			{
				IAGA: 'DC3',
				urls: ['https://earthref.org/MagIC/books/Tauxe/Essentials/#x1-1970341'],
				code: 'LP-DC3',
				definition:
					'Vector diagrams or stereoplots with M/Mo justify demagnetization procedures used',
			},
			{
				IAGA: 'DC4',
				urls: ['https://earthref.org/MagIC/books/Tauxe/Essentials/#x1-1970341'],
				code: 'LP-DC4',
				definition:
					'Principal component analysis carried out from analysis of Zijderveld diagrams',
			},
			{
				IAGA: 'DC5',
				urls: ['https://earthref.org/MagIC/books/Tauxe/Essentials/#x1-1970341'],
				code: 'LP-DC5',
				definition:
					'Magnetic vectors isolated using two or more demagnetization methods with principle component analysis',
			},
			{
				code: 'LP-DIR',
			...
			{
				description:
					'Measurement of sample NRM on squid or spinner magnetometer, cooling in liquid nitrogen bath, rewarming in zero field and then re-measuring at room temperature.',
				code: 'LP-DM-NRM',
				definition: 'Demagnetization: Room temperature NRM',
			},
			{
				description:
					'Measurement of sample SIRM on squid or spinner magnetometer, cooling in liquid nitrogen bath, rewarming in zero field and then re-measuring at room temperature.',
				code: 'LP-DM-SIRM',
			...
			},
			{
				...
				urls: [
					'https://earthref.org/MagIC/books/Tauxe/Essentials/#x1-510005.4',
				],
			},
			{
				code: 'LP-HC',
			...
			},
			{
				...
				description:
					'After demagnetization a specimen is subject to successively increasing fields, acquiring partial IRMs until saturation is reached (SIRM). Remanence is measured at each step to provide the IRM acquisition curve.',
			},
			{
				code: 'LP-IRM-3D',
				definition: 'IRM acquisition: Thermal demagnetization of 3-axis IRM',
				description:
					'IRM is applied to the specimen along three orthogonal axes at different field strengths (e.g. 5T, 0.4T, 0.12T). Then the specimen is thermally demagnetized and the magnitude along the orthogonal axis (X1,X2,X3) versus temperature is plotted.',
			},
			{
				code: 'LP-IRM-AFD',
			...
			},
			{
				...
				description:
					'DC field is applied to remove IRM. The specimen is then exposed to increasing strengths of the reverse field until the remanence reduces to zero at Bcr. The IRMs are then plotted versus applied field producing the acquisition/removal curves.',
			},
			{
				code: 'LP-LT',
			...
			},
			{
				...
				description:
					'Minimal paleointensity method code, further information, about the basic method, alteration checks, and reciprocity checks can be specified using additional LP-PI codes described below.',
			},
			{
				code: 'LP-PI-AFAF',
				definition:
					'Paleointensity experiment: AF demag of the NRM followed by AF demag of a TRM',
				description:
					'This paleointensity method uses the Shaw (1974) method but without the two ARM demagnetiztion procedures that might indicate the rock has been altered by heating.',
			},
			{
				code: 'LP-PI-ALT',
				definition: 'Paleointensity experiment: Alteration check',
				description:
					'This code is used to indicate that some kind of check was used to detect alteration of the sample during the course of the paleointensity experiments. More details can be specified using the supplemental codes described below.',
			},
			{
				code: 'LP-PI-ALT-AFARM',
				definition:
					'Paleointensity experiment: Alteration check using AF demagnetization of ARM',
				description:
					'A method to detect alteration that uses AF demagnetization of an ARM, before and after heating to impart TRM. Changes in the ARM coercivity spectrum indicate alteration.',
			},
			{
				code: 'LP-PI-ALT-AFTRM',
				definition:
					'Paleointensity experiment: Alteration check using AF coercivity spectrum before and after TRM acquisition',
				description:
					'Check that AF coercivity spectrum does not change during paleointensity experiment.',
			}, // {
			...
			//},
			{
				code: 'LP-PI-ALT-PMRM',
				definition:
					'Paleointensity experiment: Alteration check using a partial microwave induced TRM check',
				description:
					'This is a check for reproducibility of pTRM acquisition at a specific temperature. During a Thellier-type paleointensity experiment, the specimen is reheated to a lower temperature and cooled in the laboratory field, thus reapplying a pTRM.',
			},
			{
				code: 'LP-PI-ALT-PTRM',
				definition:
					'Paleointensity experiment: Alteration check using a pTRM check',
				description:
					'This is a check for reproducibility of pTRM acquisition at a specific temperature. During a Thellier-type paleointensity experiment, the specimen is reheated to a lower temperature and cooled in the laboratory field, thus reapplying a pTRM. Coe (1967)',
			...
			},
			{
				...
				definition:
					'Paleointensity experiment: Alteration check of Tanguy (1975)',
				urls: ['https://doi.org/10.1016/0012-821X(75)90043-6'],
			},
			{
				code: 'LP-PI-ALT-WALTON',
				definition:
					'Paleointensity experiment: Alteration check of Walton (1984)',
				urls: ['https://doi:10.1038/310740a0'],
			},
			{
				code: 'LP-PI-ARM',
				definition:
					'Paleointensity experiment: Using a laboratory ARM to normalize NRM for paleofield estimation',
				description:
					'Relative Paleointensity method. Any paleointensity experiment in which a laboratory ARM is used to normalize NRM for paleofield estimation, as suggested by Levi and Banerjee (1976) or the more detailed pseudo-Thellier experiments of Tauxe et al . (1995).',
			},
			{
				code: 'LP-PI-BT',
				definition: 'Paleointensity experiment: Reciprocity check',
				description:
					'Reciprocity checks are used to determine whether the blocking and unblocking process is the same at a given temperature during a Thellier-type experiment. This is considered an indicator of the types of grains (single or multidomain) present in the specimen.',
			},
			{
				code: 'LP-PI-BT-BZF',
				definition:
					'Paleointensity experiment: Reciprocity check using an in-field back step, a zero-field step, and an in-field forward step',
				description:
					' A comprehensive back-zero-forth(BZF) heating technique adds an additional zero-field heating between the Thellier two opposite in-field heating steps in order to estimate paleointensities in various standard protocols and provide internalself-consistency checks. Wang And Kent. (2013)',
				urls: ['https://doi.org/10.1002/ggge.20248'],
			},
			{
				code: 'LP-PI-BT-IZZI',
				definition:
					'Paleointensity experiment: Reciprocity check using an in-field step, followed by two zero-field steps, followed by an in-field step',
				description:
					'Heating to a specific temperature to remove NRM and then cooling in a known magnetic field to induce TRM. Followed by heating to the same or lower temperature step and then cooling in zero ambient magnetic field. Then another zero field step followed an in-field step. Yu et al. (2004)',
				urls: ['https://doi.org/10.1029/2003GC000630'],
			},
			{
				code: 'LP-PI-BT-MD',
				definition:
					'Paleointensity experiment: Reciprocity check using an attempted removal of a previously placed pTRM',
				description:
					'A check carried out during Thellier-type procedures to detect multidomain grains. Additional zero field heating steps are used to remove a previously placed pTRM. The ability to remove a prior pTRM step at the same temperature imparted is used as an indicator of reversal.',
			},
			{
				code: 'LP-PI-CHEM',
			...
			},
			{
				code: 'LP-PI-II',
				definition:
					'Paleointensity experiment: Original Thellier-Thellier method',
				description:
					"Paleointensity determined with in-field and in-field steps. Analogous to LP-PI-IZ (infield, zero field) and LP-PI-ZI (zero field, infield). Thellier, E. and O. Thellier, Sur l'intensite du champ magnetique terrestre dans le passe historique et geologique, Ann. Geophys., 15, 285-376, 1959.",
			},
			{
				code: 'LP-PI-IRM',
				definition:
					'Paleointensity experiment: Using a laboratory IRM to normalize NRM for paleofield estimation',
				description:
					'Use of a laboratory IRM to normalize NRM for paleofield estimation.',
			},
			{
				code: 'LP-PI-IZ',
				definition:
			...
			},
			{
				...
				description:
					'Use of microwave radiation as the energy source to unblock NRM and/or for in-field remanence acquisition.',
			}, //{
			...
			// },
			{
				code: 'LP-PI-M-II',
				definition:
					'Paleointensity experiment: Microwave demagnetization with an in-field step followed by another in-field step (classical Thellier experiment)',
				description:
					'Microwave demagnetization of the specimen and then relaxing in known ambient magnetic field. The same step is then repeated.',
			},
			{
				code: 'LP-PI-M-IZ',
				definition:
					'Paleointensity experiment: Using a microwave TRM with an in-field step followed by a zero-field step',
				description:
					'Microwave demagnetization of the specimen to the desired step and then relaxing in known ambient magnetic field. Then microwave demagnetization to the same or lower step and then relaxing in zero magnetic field to induce pTRM.',
			},
			{
				code: 'LP-PI-M-IZZI',
				definition:
					'Paleointensity experiment: Microwave reciprocity check using an in-field step, followed by two zero-field steps, followed by an in-field step',
				description:
					'Microwave demagnetization to a specific step to remove NRM and then relaxation in a known magnetic field. Followed by microwave demagnetization to the same or lower step and then relaxation in zero ambient magnetic field. Then another zero field step followed an in-field step',
			},
			{
				code: 'LP-PI-M-PERP',
				definition:
					'Paleointensity experiment: Microwave heating with perpendicular protocol',
				description:
					'Use of microwave radiation as the energy source to unblock NRM and/or for in-field remanence acquisition. Perpendicular protocol. Each step includes a single infield step with lab field perpendicular to the NRM. The protocol can include demagnetization steps until overprint is removed.',
			},
			{
				code: 'LP-PI-M-QP',
				definition:
					'Paleointensity experiment: Microwave heating with quasi-perpendicular protocol',
				description:
					'Use of microwave radiation as the energy source to unblock NRM and/or for in-field remanence acquisition. Quasi-perpendicular protocol. Biggin et al. (2007)',
				urls: ['https://doi.org/10.1016/j.epsl.2007.03.016'],
			},
			{
				code: 'LP-PI-M-ZI',
				definition:
					'Paleointensity experiment: Using a microwave TRM with a zero-field step followed by an in-field step',
				description:
					'Heating the specimen to the desired temperature step and then cooling in zero ambient magnetic field. Then heating to the same or lower temperature and then cooling in a known magnetic field to induce pTRM.',
			},
			{
				code: 'LP-PI-MULT',
				definition:
					'Paleointensity experiment: Using a multi-specimen procedure',
				description: 'Psuedo theiller?? XXXXX Tauxe 1995.',
			},
			{
				code: 'LP-PI-MULT-DB',
				definition:
					'Paleointensity experiment: Using a multi-specimen procedure of Dekkers and Bohnel.',
			...
			},
			{
				code: 'LP-PI-MULT-FL',
				definition:
					'Paleointensity experiment: Using a multi-specimen procedure of Fabian and Leonhardt.',
				description:
					'Modification of Dekkers and Bohnel (2006) method. Fabian and Leonhardt (2010), 10.1016/j.epsl.2010.06.006',
			...
			},
			{
				...
				description:
					'Any paleointensity experiment that uses a TRM produced in a lab controlled field. Includes all variants of the Thellier method, including the Shaw method. More details on alteration and reciprocity checks can be added using the special LP-PI-ALT and LP-PI-BT method codes.',
			},
			{
				code: 'LP-PI-TRM-II',
				definition:
					'Paleointensity experiment: Using a laboratory TRM with an in-field step followed by another in-field step (classical Thellier experiment)',
				description:
					'Heating the specimen to the desired temperature step and then cooling in known ambient magnetic field. The same step is then repeated. Ref:Thellier, O. and Thellier, E. (1959). Sur la direction du champ magnetique terrestre dans le passe historique et geologique. Annales de Geophysique 15: 285-375.',
			},
			{
				code: 'LP-PI-TRM-IZ',
				definition:
					'Paleointensity experiment: Using a laboratory TRM with an in-field step followed by a zero-field step',
				description:
					'Heating the specimen to the desired temperature step and then cooling in known ambient magnetic field. Then heating to the same or lower temperature and then cooling in zero magnetic field to induce pTRM. Aitken et al., (1988)',
				urls: ['https://doi.org/10.1029/RG026i001p00003'],
			},
			{
				code: 'LP-PI-TRM-PERP',
				definition:
					'Paleointensity experiment: Using a laboratory TRM with perpendicular protocol',
				description:
					'Each step includes a single infield step with lab field perpendicular  to the NRM. The protocol can include demagnetizations steps until overprint is removed.',
			},
			{
				code: 'LP-PI-TRM-W',
				definition:
					'Paleointensity experiment: Using a laboratory TRM measured at temperature',
				description:
					'Wilson method (Wilson, 1961) where the field of a specimen is measured at temperature (unblocking) instead of the easier and more common method of the specimen being measured after cooling (blocking).',
				urls: ['https://doi.org/10.1111/j.1365-246X.1961.tb02928.x'],
			},
			{
				code: 'LP-PI-TRM-ZI',
				definition:
					'Paleointensity experiment: Using a laboratory TRM with a zero-field step followed by an in-field step',
				description:
					'Heating the specimen to the desired temperature step and then cooling in zero ambient magnetic field. Then heating to the same or lower temperature and then cooling in a known magnetic field to induce pTRM. Coe (1967)',
				urls: ['https://doi.org/10.1029/JZ072I012P03247'],
			},
			{
				code: 'LP-PI-X',
			...
			},
			{
				code: 'LP-QDM-R',
				definition:
					'A quantum diamond microscope (QDM) experiment - remanent magnetization mapping',
				description:
			...
			},
			{
				code: 'LP-QDM-I',
				definition:
					'A quantum diamond microscope (QDM) experiment - induced magnetization mapping',
				description:
			...
			},
			{
				...
				urls: [
					'https://doi.org/10.1002/2016GC006487',
					'https://doi.org/10.1016/j.epsl.2016.09.038',
				],
			},
			{
			...
			},
			{
				code: 'LP-X-DC',
				definition:
					'Susceptibility measurement: As a function of external DC field',
				description:
					'An external DC field is varied while measuring the susceptibility.',
			},
			{
				code: 'LP-X-F',
			...
			},
			{
				code: 'LP-X-FERRO',
				definition:
					'Susceptibility measurement: Independent measurements of low field and highfield susceptibility for getting ferromagnetic susceptibility',
				description:
					'Ferromagnetic susceptibility is the low-field minus the high-field susceptibility to correct for paramagnetic contribution.',
			},
			{
				code: 'LP-X-H',
			...
			},
			{
				...
				description:
					"The magnetic contrast is provided by X‐ray magnetic circular dichroism, where the efficiency of electron ejection from the sample's surface by circularly polarized X‐rays depends on the relative orientation of the local magnetic moment and the X‐ray beam. This can be used to calculate the local magnetic moment and paleointensities. (van der Laan, 2013; Bryson, Herrero-Albillos et al., 2014)",
				urls: [
					'https://doi.org/10.1088/1742-6596/430/1/012127',
			...
			},
			{
				code: 'LP-XPEEM-1',
				definition:
					'X‐ray photoelectron emission microscopy: One specimen orientation',
				description:
					"The magnetic contrast is provided by X‐ray magnetic circular dichroism, where the efficiency of electron ejection from the sample's surface by circularly polarized X‐rays depends on the relative orientation of the local magnetic moment and the X‐ray beam. This can be used to calculate the local magnetic moment and paleointensities. Each spot is measured in one orientation. (Bryson et al., 2015; Nichols et al. 2018)",
				urls: [
			...
			},
			{
				code: 'LP-XPEEM-3',
				definition:
					'X‐ray photoelectron emission microscopy: Three specimen orientations',
				description:
					"The magnetic contrast is provided by X‐ray magnetic circular dichroism, where the efficiency of electron ejection from the sample's surface by circularly polarized X‐rays depends on the relative orientation of the local magnetic moment and the X‐ray beam. This can be used to calculate the local magnetic moment and paleointensities. Each spot is measured in three orientations rotated by 120 degrees. This allows for direct estimates of the direction and intensity of the ancient field. (Bryson et al., 2019)",
	...
	lab_treatment: {
		codes: [
			...
			},
			{
				...
				IAGA: 'A',
				urls: [
					'https://earthref.org/MagIC/books/Tauxe/Essentials/WebBook3ch5.html#LT-AFI',
				],
				description:
					'AF demagnetization in a small DC field offset to produce an ARM.',
			...
			},
			{
				...
				description:
					'A specimen is subject to a decaying and alternating magnetic field such that the magnetic moments with coercivities below the peak field are aligned in opposed directions, and thus cancel. Specimens are typically reoriented in three or more orthogonal axes.',
				urls: [
					'https://earthref.org/MagIC/books/Tauxe/Essentials/WebBook3ch9.html#LT-AFZ',
				],
				IAGA: 'A',
			},
			{
				...
				description:
					'A specimen is subject to a decaying and alternating magnetic field such that the magnetic moments with coercivities below the peak field are aligned in opposed directions, and thus cancel. Specimens are oriented along the X axis.',
				urls: [
					'https://earthref.org/MagIC/books/Tauxe/Essentials/WebBook3ch9.html#LT-AFZ',
				],
			},
			{
				code: 'LT-AF-Z-XYZ',
				definition:
					'Alternating field: In zero field along the X, then the Y, and then the Z axes',
				description:
					'A specimen is subject to a decaying and alternating magnetic field such that the magnetic moments with coercivities below the peak field are aligned in opposed directions, and thus cancel. Specimens are oriented along the X axis, then the Y axis, and finally the Z axis.',
				urls: [
					'https://earthref.org/MagIC/books/Tauxe/Essentials/WebBook3ch9.html#LT-AFZ',
				],
			},
			{
				code: 'LT-AF-Z-XZY',
				definition:
					'Alternating field: In zero field along the X, then the Z, and then the Y axes',
				description:
					'A specimen is subject to a decaying and alternating magnetic field such that the magnetic moments with coercivities below the peak field are aligned in opposed directions, and thus cancel. Specimens are oriented along the X axis, then the Z axis, and finally the Y axis.',
				urls: [
					'https://earthref.org/MagIC/books/Tauxe/Essentials/WebBook3ch9.html#LT-AFZ',
				],
			},
			{
				...
				description:
					'A specimen is subject to a decaying and alternating magnetic field such that the magnetic moments with coercivities below the peak field are aligned in opposed directions, and thus cancel. Specimens are oriented along the Y axis.',
				urls: [
					'https://earthref.org/MagIC/books/Tauxe/Essentials/WebBook3ch9.html#LT-AFZ',
				],
			},
			{
				code: 'LT-AF-Z-YXZ',
				definition:
					'Alternating field: In zero field along the Y, then the X, and then the Z axes',
				description:
					'A specimen is subject to a decaying and alternating magnetic field such that the magnetic moments with coercivities below the peak field are aligned in opposed directions, and thus cancel. Specimens are oriented along the Y axis, then the X axis, and finally the Z axis.',
				urls: [
					'https://earthref.org/MagIC/books/Tauxe/Essentials/WebBook3ch9.html#LT-AFZ',
				],
			},
			{
				code: 'LT-AF-Z-YZX',
				definition:
					'Alternating field: In zero field along the Y, then the Z, and then the X axes',
				description:
					'A specimen is subject to a decaying and alternating magnetic field such that the magnetic moments with coercivities below the peak field are aligned in opposed directions, and thus cancel. Specimens are oriented along the Y axis, then the Z axis, and finally the X axis.',
				urls: [
					'https://earthref.org/MagIC/books/Tauxe/Essentials/WebBook3ch9.html#LT-AFZ',
				],
			},
			...
			},
			{
				code: 'LT-AF-Z-ZXY',
				definition:
					'Alternating field: In zero field along the Z, then the X, and then the Y axes',
				description:
					'A specimen is subject to a decaying and alternating magnetic field such that the magnetic moments with coercivities below the peak field are aligned in opposed directions, and thus cancel. Specimens are oriented along the Z axis, then the X axis, and finally the Y axis.',
				urls: [
					'https://earthref.org/MagIC/books/Tauxe/Essentials/WebBook3ch9.html#LT-AFZ',
				],
			},
			{
				code: 'LT-AF-Z-ZYX',
				definition:
					'Alternating field: In zero field along the Z, then the Y, and then the X axes',
				description:
					'A specimen is subject to a decaying and alternating magnetic field such that the magnetic moments with coercivities below the peak field are aligned in opposed directions, and thus cancel. Specimens are oriented along the Z axis, then the Y axis, and finally the X axis.',
				urls: [
					'https://earthref.org/MagIC/books/Tauxe/Essentials/WebBook3ch9.html#LT-AFZ',
				],
			},
			{
				code: 'LT-AF-Z-TUMB',
				description:
					'A specimen is subject to a decaying and alternating magnetic field using a tumbling demagnetizer such that the magnetic moments with coercivities below the peak field are aligned in opposed directions, and thus cancel. Specimens are typically reoriented in three or more orthogonal axes.',
				definition:
					'Alternating field: In zero field using a tumbling AF demagnetizer',
			},
			{
				code: 'LT-CHEM',
			...
			{
				description:
					'In zero field the specimen is cooled to low temperature and warmed prior to measurement. Low temperature cycling of specimens can detect presence of particles whose magnetic properties depend on magnetocrystalline anisotropy, including multidomain grains.',
				code: 'LT-LT-Z',
			...
			},
			{
				...
				code: 'LT-TRM-PAR',
				definition:
					'Specimen heating and cooling: Laboratory field parallel to the TRM vector',
			},
			{
				code: 'LT-NRM-PERP',
				definition:
			...
			},
			{
				...
				description:
					'A modification of the Thellier–Thellier experiment that detects the presence of MD particles by verifying the law of additivity of pTRMs. The law of additivity is valid for regular pTRMs (i.e. the upper temperature of pTRM acquisition is reached by cooling from the Curie temperature) for both SD and MD particles, whereas it is not valid for pTRM* (the upper temperature of pTRM acquisition is reached by heating from room temperature) in the case of MD particles. As the partial thermoremanences imparted in Thellier–Thellier experiments are of the pTRM* type, additivity as a prerequisite for the validity of the obtained result is not given if the remanence is carried predominantly by MD particles (Krasa et al., 2003).',
				code: 'LT-PMRM-AC',
				definition:
					'pTRM check: additivity check step while using microwave demagnetization',
			},
			{
				description:
					'After treatment at a particular temperature step, the specimen is then reheated to a lower temperature and cooled with the laboratory field on thus reapplying a pTRM.',
				code: 'LT-PMRM-I',
				definition:
					'pMRM check: After zero field step, perform an in field cooling after heating to lower T with  microwave radiation',
			},
			{
				description:
					'A check carried out during Thellier procedures to detect multidomain grains. Additional zero field heating steps are used to remove a previously placed pTRM. The ability to remove a prior pTRM step at the same temperature imparted is used as an indicator of reversal.',
				code: 'LT-PMRM-MD',
				definition:
					'pMRM tail check: After in laboratory field step, perform a zero field cooling after heating with same microwave power and time ',
			},
			{
				description:
					'After heating to a particular temperature step and cooling in field. The specimen is heated to a lower temperature step and cooled in zero field. This checks for low temperature pTRM tails.',
				code: 'LT-PMRM-Z',
				definition:
					'pMRM tail check: After in laboratory field step, perform a zero field cooling after microwave heating at a lower power/time',
			},
			{
				urls: ['https://doi.org/10.1016/S1474-7065(03)00122-0'],
				description:
				...
				code: 'LT-PTRM-AC',
				definition:
					'pTRM check: additivity check step while using thermal demagnetization',
			},
			{
				code: 'LT-PTRM-I',
				definition:
					'pTRM check: After zero field step, perform an in field cooling',
				description:
					'After treatment at a particular temperature step, the specimen is then reheated to a lower temperature and cooled with the laboratory field on thus reapplying a pTRM.',
				urls: [
					'https://earthref.org/MagIC/books/Tauxe/Essentials/WebBook3ch10.html#LT-pTRMI',
				],
			},
			{
				description:
			...
			{
				urls: [
					'https://earthref.org/MagIC/books/Tauxe/Essentials/WebBook3ch10.html#LT-pTRMZ',
				],
				description:
					'After heating to a particular temperature step and cooling in field. The specimen is heated to a lower temperature step and cooled in zero field. This checks for low temperature pTRM tails.',
				code: 'LT-PTRM-Z',
			...
			},
			{
				code: 'LT-T-I',
				urls: [
					'https://earthref.org/MagIC/books/Tauxe/Essentials/WebBook3ch10.html#LT-TI',
				],
				description:
					'Heating to a specific temperature to remove NRM and then cooling in a known magnetic field to induce TRM.',
			...
			},
			{
				...
				description:
					'Heating the specimen to the desired temperature step and then cooling in zero ambient magnetic field.',
				urls: [
					'https://earthref.org/MagIC/books/Tauxe/Essentials/WebBook3ch9.html#LT-TZ',
				],
			},
			{
				code: 'LT-T-Z-NRM-PAR',
				...
				description:
					'Heating to temperature  in zero field, then cooling in a field parallel to the NRM. Dekkers and Bohnel (2006), doi:10.1016/j.epsl.2006.05.040',
				urls: ['https://doi.org/10.1016/j.epsl.2006.05.040'],
			},
			{
				IAGA: 'V',
				description:
					'Placing a specimen in a zero field environment (often a MU-metal shield) allows for the relaxation of the softest components of magnetization. This randomizing effect can then be measured over time. MU-metal is Ni-Fe alloy of high permeability.',
				code: 'LT-VD',
	...
	geochronology_method: {
		codes: [
			...
			{
				description:
					'Relative dating by cross-cutting relationships in the field. This method code should not be used instead of GM-STRAT if dealing with a stratigraphic succession.',
				code: 'GM-CC-REL',
				definition:
	...
	sample_characterization: {
		codes: [
			...
			},
			{
				...
				definition: 'X‐ray photoelectron emission microscopy',
				description:
					"The magnetic contrast is provided by X‐ray magnetic circular dichroism, where the efficiency of electron ejection from the sample's surface by circularly polarized X‐rays depends on the relative orientation of the local magnetic moment and the X‐ray beam. This can be used to calculate the local magnetic moment and paleointensities. (Bryson, Herrero-Albillos et al., 2014)",
	...
	stability_tests: {
		codes: [
			...
			},
			{
				urls: ['10.1029/2000JB000050'],
				description:
					'There must be a sufficient number of individually oriented samples from enough sites. At least six sites and 36 samples, each site having a 95% confidence interval less than 10∘ in the Cenozoic and 15∘ in the Mesozoic.',
				code: 'ST-BCQ-2',
			...
			},
			{
				urls: ['10.1029/2000JB000050'],
				description:
					'The age of the magnetization relative to the age of the rock should be constrained using field tests (fold test, conglomerate test, baked contact test. Reject poles that fail a fold test or a reversals test.',
				code: 'ST-BCQ-4',
			...
			},
			{
				IAGA: 'C*',
				description:
					'This is the inverse of the baked contact test. If stable magnetizations are observed in unbaked rocks that provide positive evidence for a baked contact test, then this also provides evidence that the unbaked sediments have retained their magnetization, at least since the time of baking.',
				code: 'ST-C-I',
			...
			},
			{
				IAGA: 'G*',
				description:
					'This is a variation on the conglomerate test, where the conglomerate lies within the formation and was deposited not long after the parent beds were deposited.',
				code: 'ST-G-IF',
			...
			},
			{
				IAGA: 'R',
				description:
					'This reversal test compares the overlap of confidence intervals for bootstrapped means of reversed antipodal data. If the confidence intervals for the normal and reversed data overlap, then this suggests that the two means cannot be distinguished at the 95% level of confidence.',
				code: 'ST-R-3',
				definition:
					'Reversals test 3: Compares bootstrapped means for N and R antipodes by testing for common mean',
			},
			{
				IAGA: 'R',
				code: 'ST-R-4',
			...
			},
			{
				IAGA: 'U',
				description:
					'This unconformity test is applied in special cases when successive zones of normal and reverse magnetization are truncated by an unconformity in the sequence. If the polarity zones of the upper/younger sequence do not match those of the lower/older sequence, then the magnetization of the lower beds is older than the episode of erosion that created the unconformity.',
				code: 'ST-U',
			...
			},
			{
				...
				description:
					'The age of the formation must be known rather accurately. The age should be known to within a half of a geological period or within a numerical age of ± 4% for Phanerozoic data. For Precambrian rocks, the age should be known to within ± 4% or 40 Myr, whichever is smaller.',
				code: 'ST-VVQ-1',
			...
			},
			{
				urls: ['http://dx.doi.org/10.1029/rg028i002p00167'],
				description:
					'There must be a sufficient number of individually oriented samples from enough sites. A minimum of 24 discrete samples of the geomagnetic field each having a κ > 10.',
				code: 'ST-VVQ-2',
			...
			},
			{
				urls: ['http://dx.doi.org/10.1029/rg028i002p00167'],
				description:
					'It must be demonstrated that a coherent characteristic remanence component has been isolated by the demagnetization procedure.',
				code: 'ST-VVQ-3',
			...
			},
			{
				urls: ['http://dx.doi.org/10.1029/rg028i002p00167'],
				description:
					'The age of the magnetization relative to the age of the rock should be constrained using field tests (fold test, conglomerate test, baked contact test).',
				code: 'ST-VVQ-4',
			...
			},
			{
				urls: ['http://dx.doi.org/10.1029/rg028i002p00167'],
				description:
					'There should be agreement in the pole positions from units of similar age from a broad region and adequate knowledge of any structural corrections necessary.',
				code: 'ST-VVQ-5',
			...
			},
			{
				urls: ['http://dx.doi.org/10.1029/rg028i002p00167'],
				description:
					'Both polarities should be represented and the two data sets should be antipodal.',
				code: 'ST-VVQ-6',
			...
			},
			{
				urls: ['http://dx.doi.org/10.1029/rg028i002p00167'],
				description:
					'Pole positions should not fall on a younger part of the pole path or on the present field direction.',
				code: 'ST-VVQ-7',
	...
	statistical_method: {
		codes: [
			...
			{
				description:
					'Linear temperature dependence of inverse susceptibility above ordering temperature of ferromagnets.',
				code: 'SM-EXT-LIN',
				definition: 'Linear extrapolation from above critical temperature',
			},
			{
				description:
					'Hyperbolic temperature dependence of inverse susceptibility above ordering temperature of ferromagnets.',
				code: 'SM-EXT-NL1',
				definition: 'Non-linear extrapolation from above critical temperature',
			},
			{
				description:
					'Theoretical decay of Ms versus T to estimate Curie temperature.',
				code: 'SM-EXT-NL2',
	...
	data_adjustment: {
		codes: [
			...
			},
			{
				...
				code: 'DA-CR-PS',
				definition:
					'Cooling rate correction: Percent estimated from pilot samples',
			},
			{
				urls: ['https://earthref.org/MagIC/books/Tauxe/Essentials/#x1-1180067'],
				code: 'DA-CR-TRM',
				definition:
					'Cooling rate correction: Comparison between 2 TRMs acquired with a slow and rapid cooling rate',
			},
			{
				code: 'DA-DC',
